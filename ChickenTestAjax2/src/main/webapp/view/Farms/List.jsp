...
<script type="text/javascript" src="<%=request.getContextPath()%>/resources/scriptF.js"></script>
...
<th><spring:message code="th.Update" /></th>
<th><spring:message code="th.Delete" /></th>
</tr>
</thead>
<tbody id="results">
</tbody>
